...
powershell "Remove-Item -Path function.zip -ErrorAction SilentlyContinue; Compress-Archive -Path index.mjs,package.json,node_modules,lib,handlers -DestinationPath function.zip -Force"
