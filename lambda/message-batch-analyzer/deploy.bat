@echo off
echo Deploying message-batch-analyzer Lambda function...
...
aws lambda get-function --function-name ai-co-learner-message-batch-analyzer --region ap-northeast-2 --query "Configuration.LastUpdateStatus"
