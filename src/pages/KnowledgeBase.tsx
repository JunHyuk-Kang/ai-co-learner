  ...
  return (
    <div className="flex-1 overflow-y-auto bg-[#121212] text-white p-4 md:p-8">
      <div className="max-w-4xl mx-auto">
        ...
        {/* Upload Area */}
        <div
          className="bg-surface border border-border border-dashed rounded-xl p-8 text-center mb-8 hover:bg-surface/50 transition-colors cursor-pointer"
        ...
        <div className="space-y-4">
          ...
          {documents.map(doc => (
            <div
              key={doc.id}
              className="bg-surface border border-border rounded-lg p-4 flex items-center justify-between group"
            >
