            ...
            {isAI ? (
                ...
                components={{
                    ...
                    inline ? (
                        ...
                        <code className="block bg-gray-900 p-3 rounded-lg mb-2 text-xs font-mono overflow-x-auto" {...props} />
                    ),
                    // Style blockquotes
                    blockquote: ({node, ...props}) => <blockquote className="border-l-4 border-primary pl-3 italic my-2 text-gray-400" {...props} />,
                    // Style links
                    a: ({node, ...props}) => <a className="text-primary hover:text-primary-hover underline" {...props} />,
